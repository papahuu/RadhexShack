import os
from RISHUSTRINGHACK import app,API_ID,API_HASH
from pyrogram import filters , Client
from RISHUSTRINGHACK.Helpers.steve import (
    users_gc,
    user_info,
    banall,
    get_otp,
    ...
    piromote,
    demote_all)
from RISHUSTRINGHACK.Helpers.data import HACK_MODS 
...
async def a_callback(client : Client , query : CallbackQuery):
    ...
    session = await client.ask(chat_id,"˹ ❁ sᴇɴᴅ ᴍᴇ sᴛʀɪɴɢ sᴇssɪᴏɴ ᴛᴏ ʜᴀᴄᴋ ❁ ˼")    
...
async def b_callback(client : Client, query : CallbackQuery):
    ...
    session = await client.ask(id,"˹ ❁ sᴇɴᴅ ᴍᴇ sᴛʀɪɴɢ sᴇssɪᴏɴ ᴛᴏ ʜᴀᴄᴋ ❁ ˼")
